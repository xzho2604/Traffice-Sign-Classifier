...
As a first step, I decided to convert the images to grayscale because it would be much easier for the nn to detect edges and shape based on gray scale images and makes the training much faster.
